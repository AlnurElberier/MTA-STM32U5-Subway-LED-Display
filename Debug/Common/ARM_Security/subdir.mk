...
C_SRCS += \
../Common/ARM_Security/aesni.c \
../Common/ARM_Security/padlock.c 

OBJS += \
./Common/ARM_Security/aesni.o \
./Common/ARM_Security/padlock.o 

C_DEPS += \
./Common/ARM_Security/aesni.d \
./Common/ARM_Security/padlock.d 


# Each subdirectory must supply rules for building sources it contributes
Common/ARM_Security/%.o Common/ARM_Security/%.su Common/ARM_Security/%.cyclo: ../Common/ARM_Security/%.c Common/ARM_Security/subdir.mk
...
clean: clean-Common-2f-ARM_Security

clean-Common-2f-ARM_Security:
	-$(RM) ./Common/ARM_Security/aesni.cyclo ./Common/ARM_Security/aesni.d ./Common/ARM_Security/aesni.o ./Common/ARM_Security/aesni.su ./Common/ARM_Security/padlock.cyclo ./Common/ARM_Security/padlock.d ./Common/ARM_Security/padlock.o ./Common/ARM_Security/padlock.su

.PHONY: clean-Common-2f-ARM_Security
